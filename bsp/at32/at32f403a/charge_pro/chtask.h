...
#define CP_12V_MIN                  9501   //csh412原来10001

#define CP_9V_MAX                   9500  //csh412原来10000
#define CP_9V_MIN                   6501

#define CP_6V_MAX                   6500
#define CP_6V_MIN                   3500    //原来4500
...
typedef struct
{
    uint16_t  usCurrent;              // rn8112 A电流 单位0.01A
    uint16_t  usVolt;                 // rn8112 A电压 单位0.1V
    uint16_t  uiE_A;                  // rn8209 A相总电量 0.001 kWH

    uint16_t  usCurrentb;             // rn8112 B电流 单位0.01A
    uint16_t  usVoltb;                // rn8112 B电压 单位0.1V
    uint16_t  uiE_B;                  // rn8209 B相总电量 0.001 kWH

    uint16_t  usCurrentc;             // rn8112 C电流 单位0.01A
    uint16_t  usVoltc;                // rn8112 C电压 单位0.1V
    uint16_t  uiE_C;                  // rn8209 C相总电量 0.001 kWH
...
__packed typedef struct
{
	...
	uint64_t	 jsviDChQ[3];			//计算得时候精确到 0.0000001度
	uint32_t     viDChQ[3]; 			//通过电压电流计算  0.001
